...
echo "  ${ADMIN_SECRET}"
echo ""
echo "IMPORTANT — configure once in the Railway dashboard:"
echo ""
echo "  1. Add a VOLUME (not under Settings): open the project canvas, press Ctrl+K,"
echo "     search 'Volume', or right-click the canvas → create volume."
echo "     Select your web service, mount path: /app/data"
echo "     (Without this, users/leagues are wiped on every redeploy.)"
